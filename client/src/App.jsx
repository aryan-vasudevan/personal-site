...
function App() {
    ...
    const [spotifyTrack] = useState(() => {
        const tracks = [
            'https://open.spotify.com/embed/track/58TaFP5j5i9swOf584yon2?utm_source=generator&theme=1',
            'https://open.spotify.com/embed/track/2cYqizR4lgvp4Qu6IQ3qGN?utm_source=generator&theme=1',
            'https://open.spotify.com/embed/track/1cZlBZwnwGPtYeRIeQcoFh?utm_source=generator&theme=1',
            'https://open.spotify.com/embed/track/3KkXRkHbMCARz0aVfEt68P?utm_source=generator&theme=1',
            'https://open.spotify.com/embed/track/4JRe23RYB0fN3rkYj1Uqm2?utm_source=generator&theme=1',
            'https://open.spotify.com/embed/track/4kfeRwpq5KUaqTkgi4TbDF?utm_source=generator&theme=1',
            'https://open.spotify.com/embed/track/7hxHWCCAIIxFLCzvDgnQHX?utm_source=generator&theme=1',
            'https://open.spotify.com/embed/track/4y5tKWeAUcaFE6O8Fa8XsY?utm_source=generator&theme=1',
            'https://open.spotify.com/embed/track/7AbLGIOzFkx6jHq5en5xiH?utm_source=generator&theme=1',
            'https://open.spotify.com/embed/track/58AGoOGbwsQMhBbH0eFLRR?utm_source=generator&theme=1',
            'https://open.spotify.com/embed/track/3xKsf9qdS1CyvXSMEid6g8?utm_source=generator&theme=1',
            'https://open.spotify.com/embed/track/7MXVkk9YMctZqd1Srtv4MB?utm_source=generator&theme=1',
        ];
            ...
            <main className="main-content">
                ...
                <div className="fade-in-up profile-spotify-container" style={{ display: 'flex', gap: '32px', alignItems: 'flex-start', marginBottom: '32px', width: '100%' }}>
                    ...
                    <iframe
                        ...
                        style={{ borderRadius: '12px', border: 0, flex: 1, height: '160px' }}
                        src={spotifyTrack}
                        allowFullScreen=""
                ...
                <footer className="social-footer fade-in-up">
                    ...
                    <a href="https://open.spotify.com/user/jcnvfilcmbb2o1ufat2t0df41?si=30cc67df99944bb1" target="_blank" rel="noopener noreferrer" className="social-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
